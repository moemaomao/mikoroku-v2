...
type LayoutRouteId = RouteId | "/" | "/about" | "/bookmark" | "/history" | "/manga/[source]/[...id]" | "/privacy" | "/reader/[source]/[...id]" | "/report" | "/settings" | null
type LayoutParams = RouteParams & { source?: string; id?: string }
