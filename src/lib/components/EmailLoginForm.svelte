<script lang="ts">
  import { loginWithEmail, registerWithEmail, getAuthError, clearAuthError } from '$lib/stores/auth.svelte';
  import { Mail } from 'lucide-svelte';

  let { onSuccess, isDarkMode = true }: { onSuccess: () => void; isDarkMode?: boolean } = $props();
